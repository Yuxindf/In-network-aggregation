...
class Client1:
    def __init__(self):
        ...
        # To draw diagrams
        self.info_file = "client/info.txt"  # Store file of information
        self.info = self.load_file(self.info_file)  # Store information for test part
        self.info = collections.OrderedDict(self.info)
